...
RestTemplate: HI_RestTemplate

Feign Client: HI_Feign-Client

WebClient: HI_WebClient
...
Compare the latency and throughput of the three clients under similar conditions.

Assess resource utilization, including CPU, memory, and energy consumption.

Evaluate resilience in failure scenarios, such as network outages and service crashes.
